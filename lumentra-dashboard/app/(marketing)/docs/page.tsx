...
const sections: DocSection[] = [
  {
    ...
    icon: Rocket,
    items: [
      { id: "welcome", title: "Welcome to Lumentra" },
    ...
    content: (
      <div className="space-y-6">
        <p className="text-lg text-muted-foreground">
          Lumentra is your AI-powered phone assistant that answers calls for
        ...
        <div className="rounded-xl border p-6 bg-card">
          ...
          <ol className="space-y-4">
            <li className="flex gap-3">
              ...
              <span>
                Go to your Dashboard and find your Lumentra phone number
              </span>
            </li>
            <li className="flex gap-3">
              <span className="flex h-6 w-6 items-center justify-center rounded-full bg-primary text-xs font-semibold text-primary-foreground flex-shrink-0">
      ...
      <div className="space-y-6">
        <div className="space-y-4">
          <FAQ
            ...
            answer="Yes! You can forward your existing number to your Lumentra number, or we can help you port your number over completely."
          />
          <FAQ
        ...
        <div className="container flex h-16 items-center justify-between px-4">
          <div className="flex items-center gap-4">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="font-semibold">Lumentra</span>
            </Link>
