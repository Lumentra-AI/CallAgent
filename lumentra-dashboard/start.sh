...
rm -rf /home/oneknight/Work/callagent/lumentra-dashboard/.next/dev/lock 2>/dev/null
rm -rf /home/oneknight/Work/callagent/lumentra-dashboard/.next/cache 2>/dev/null

# Small delay to ensure ports are freed
sleep 1

echo "Starting Next.js..."
cd /home/oneknight/Work/callagent/lumentra-dashboard
npm run dev
