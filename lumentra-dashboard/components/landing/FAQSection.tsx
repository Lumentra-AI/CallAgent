...
const faqs = [
  {
    question: "How does Lumentra handle complex conversations?",
    answer:
      "Lumentra uses advanced large language models fine-tuned for business conversations. It can handle multi-turn dialogues, understand context, and gracefully escalate to humans when needed. Our AI is trained on millions of real business calls.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Lumentra intelligently detects when a human is needed and can either take a message, schedule a callback, or live transfer to your team. You have full control over escalation rules.",
  },
  {
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Everything you need to know about Lumentra.
          </p>
        </motion.div>
