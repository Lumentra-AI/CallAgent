...
const testimonials = [
  {
    quote:
      "Lumentra transformed our dental practice. We went from missing 40% of calls to capturing every single one. Our bookings increased by 60% in the first month.",
    name: "Dr. Sarah Chen",
  ...
  {
    quote:
      "The ROI is incredible. We calculated that Lumentra saves us the equivalent of 2 full-time receptionists while providing better service.",
    name: "Jennifer Park",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
            Join thousands of businesses that trust Lumentra to handle their
            customer calls.
          </p>
        </motion.div>
