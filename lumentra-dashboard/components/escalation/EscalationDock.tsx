    ...
    >
      <div className="pointer-events-auto mx-auto max-w-7xl px-4 pb-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      {waitingCount} waiting - {formatAvgWaitTime(avgWaitTime)}{" "}
                      wait time
                    </p>
                  </div>
                </div>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.99 }}
          className={cn(
            "flex w-full items-center justify-between rounded-xl border bg-card px-4 py-3 shadow-lg transition-all",
            urgentCount > 0
            ...
            <div className="text-left">
              <div className="flex items-center gap-2">
                <span className="font-semibold text-foreground">
                  {waitingCount} {waitingCount === 1 ? "Call" : "Calls"} Waiting
                </span>
                {urgentCount > 0 && (
